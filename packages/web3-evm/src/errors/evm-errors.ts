 ...
 *
 * This is a public leaf entrypoint (`@nln/web3-evm/errors`): React-free and wagmi-free,
 * so pure domain code can use it without pulling the EVM runtime into the module graph.
 */

export type EvmErrorCode =
  /** Registry read before the consumer injected its runtime config (0001). */
