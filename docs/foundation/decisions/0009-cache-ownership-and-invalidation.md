...
- `packages/web3-evm/src/transactions/invalidation/evm-invalidation.adapter.ts`
...
- `packages/web3-evm/src/transactions/invalidation/evm-invalidation.adapter.test.ts`
