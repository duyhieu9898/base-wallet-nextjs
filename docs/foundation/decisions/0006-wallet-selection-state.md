...
- `packages/web3-evm/src/chain/selection/evm-selection.ts`
- `packages/web3-evm/src/chain/selection/use-evm-selection.ts`
- `packages/web3-evm/src/chain/selection/assert-evm-write-ready.ts`
- `packages/web3-evm/src/chain/selection/use-evm-wallet.ts`

Tests:

- `packages/web3-evm/src/chain/selection/evm-selection.test.ts`
- `packages/web3-evm/src/chain/selection/assert-evm-write-ready.test.ts`
