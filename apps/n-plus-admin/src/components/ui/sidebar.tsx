...
/** Varied widths so a column of skeletons reads as text, not as a bar chart. */
const SKELETON_WIDTHS = ["58%", "75%", "64%", "88%", "52%", "70%"] as const
...
function SidebarMenuSkeleton({
  ...
  showIcon?: boolean
  /** Picks the width. Callers rendering a list should pass the map index. */
  index?: number
}) {
  // Deterministic rather than Math.random(): a value drawn during render is
  // impure, changes on every re-render, and differs between the server and
  // client renders, which React 19 flags and hydration would mismatch on.
