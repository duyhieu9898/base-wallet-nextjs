...
This directory is documentation only. It is not an implementation, a provider,
or a claim that a second chain family is supported.
...
Create a sibling directory under `src/web3/<family>/`. The family owns its own:
